...
<head>
    ...
    <title>SIRISAH - Kelola Staff</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li><a href="customer.php"><span>Risalah</span></a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Admin</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2">TambahAdmin</button>
                                </div>
